...
export default function Autenticacao(){
    ...
    function submeter(){
        if(modo === 'login'){
            exibirErro('ocorreu erro login')
        }else{
            exibirErro('ocorreu erro cadastro')
        }
    }

    function exibirErro(msg, tempoEmSeg = 5){
        setErro(msg)
            ...
            <div className="m-10 w-full md:w-1/2 lg:w-1/3">
                ...
                {modo === 'login' ? (
                    <p className="mt-8">
                        ...
                        text-blue-500 first-letter:rover:text-blue-700 font-semibold
                        cursor-pointer
